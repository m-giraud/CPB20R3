...
def getVTPOutput(r, C_ST, psiXyl, vtpindx, directoryN, simStartSim, condition):
    ...
    vp.plot_plant(r.plant,p_name = ["xylem pressure (cm)","sucrose concentration (mmol/cm3)"],
                        ...
                        filename = "results"+ directoryN +"plotpsi"+str(int(simStartSim))+str(condition)+"at"+ str(vtpindx), 
                  range_ = [0,5000])
